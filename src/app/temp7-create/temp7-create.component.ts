...
@Component({
  selector: 'app-temp7-create',
  templateUrl: './temp7-create.component.html',
  styleUrls: ['./temp7-create.component.css']
})
export class Temp7CreateComponent implements OnInit {
