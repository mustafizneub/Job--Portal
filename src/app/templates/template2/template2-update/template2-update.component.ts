...
@Component({
  selector: 'app-template2-update',
  templateUrl: './template2-update.component.html',
  styleUrls: ['./template2-update.component.css']
})
export class Template2UpdateComponent implements OnInit {
