...
@Component({
  selector: 'app-template3-update',
  templateUrl: './template3-update.component.html',
  styleUrls: ['./template3-update.component.css']
})
export class Template3UpdateComponent implements OnInit {
